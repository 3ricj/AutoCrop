...
namespace Autocrop.AutocropTestCategory {
    ...
    public class AutocropCondition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AutocropCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}