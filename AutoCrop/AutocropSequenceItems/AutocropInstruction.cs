...
namespace Autocrop.AutocropTestCategory {
    ...
    [ExportMetadata("Category", "AutoCrop")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class AutocropInstruction : SequenceItem {
        /// <summary>
        ...
        public AutocropInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public AutocropInstruction(AutocropInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new AutocropInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AutocropInstruction)}, Text: {Text}";
        }
    }
}