...
namespace Autocrop.AutocropDrivers {
    /// <summary>
    ...
    public class AutocropWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public AutocropWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "Autocrop";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new AutocropWeatherDriver("MyUniqueId", "MyDeviceId"));
