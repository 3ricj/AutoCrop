...
namespace Autocrop.AutocropDrivers {
    ...
    /// </summary>
    public class AutocropWeatherDriver : BaseINPC, IWeatherData {
        public AutocropWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Autocrop Weather Data ({deviceId})";
        ...
        public string Category => "Autocrop Weather Driver";
