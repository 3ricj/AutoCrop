...
namespace Autocrop.AutocropDockables {
    /// <summary>
    ...
    public class AutocropDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public AutocropDockable(
            ...
            dict.Source = new Uri("Autocrop;component/AutocropDockables/AutocropDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Autocrop_AltitudeSVG"];
